...
// // Register the TextPlugin for counting text animation
...
//   { count: "100+", label: "Students Placed" },
...
//   useEffect(() => {
//     // GSAP animation for milestones count-up using TextPlugin
...
//     // GSAP animation for partners fade-in (only on desktop)
//     if (!isMobile) {
...
//       ref={
//         index !== undefined
//           ? (el) => (partnerRefs.current[index] = el)
//           : undefined
//       }
//       key={partner.name}
//       className="bg-white p-4 md:p-6 rounded-[24px] shadow-sm w-full max-w-[150px] md:max-w-[200px] h-[100px] md:h-[120px] flex items-center justify-center transition-shadow"
//     >
//       <Image
//         src={partner.logo}
...
//   return (
//     <section className="w-full py-12 md:py-24 bg-gradient-to-r from-purple-50 to-purple-200">
...
//         {/* Milestones Section */}
//         <div>
//           <h2 className="text-2xl md:text-4xl font-bold text-gray-800 text-center mb-16">
//             Milestones Achieved
//           </h2>
...
//                   className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent"
//                 >
//                   0+
//                 </div>
...
const milestones: Milestone[] = [
  { count: "10000+", label: "Students Placed" },
  { count: "5+", label: "Years of Success Legacy" },
  { count: "10000+", label: "Students Trained" },
];
