...
//             </motion.div> */}
//             <motion.div
//               className="text-purple-600 flex-shrink-0 relative"
//               whileHover={{ scaleY: 1.5 }} // Bar grows vertically
//               transition={{ duration: 0.5 }}
//               style={{ transformOrigin: "bottom center" }} // Anchor growth from the bottom
//             >
//               {/* <div className="w-12 h-12 sm:w-16 sm:h-16 bg-purple-600 rounded"></div> */}
//               <BsGraphUpArrow className="w-12 h-12 sm:w-16 sm:h-16" />
//             </motion.div>
