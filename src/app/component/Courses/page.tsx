...
const courses = [
  {
    ...
    link: "java-full-stack", // Add course-specific links
  },
  {
...
const achievements = [
  ...
  { title: "Students Trained", count: 100 },
...
export default function CoursesPage() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-r from-purple-50 to-purple-200"
    >
      {/* Navbar */}
      ...
      <main className="container mx-auto px-4 py-8 pt-28">
        ...
        >
          <motion.h1
            variants={fadeInUp}
            className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 text-purple-800 leading-tight"
          >
            A Technical Institute That Makes You
          </motion.h1>
          <motion.h2
            variants={fadeInUp}
            className="text-2xl sm:text-3xl font-semibold mb-4 text-purple-700"
          >
            Professional
          </motion.h2>
          <motion.p
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-3xl sm:text-4xl font-bold text-center mb-8 text-purple-800"
          >
            Courses
          </motion.h2>
          <motion.div
        ...
        >
          <motion.div variants={fadeInUp}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 text-purple-700 leading-tight">
              We're Changing the Ways You Learn New Things
            </h2>
            <p className="text-lg sm:text-xl mb-8 text-gray-800 leading-relaxed">
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                <motion.div
                  ...
                  className="text-4xl sm:text-5xl font-bold text-purple-600 mb-2"
                >
                  {achievement.count}+
                </motion.div>
        ...
        >
          ...
          >
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 mb-4 sm:mb-0">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-800 max-w-2xl text-center sm:text-left">
