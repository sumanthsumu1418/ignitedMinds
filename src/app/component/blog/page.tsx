...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <div className="text-center mb-16 relative bg-black px-4 py-8 sm:py-12 mb-4">
      <h2
        ref={headingRef}
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight h-12 text-white mb-18"
        style={{
          fontFamily: "Lexend, sans-serif",
        }}
      >
