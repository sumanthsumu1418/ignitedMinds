...
//               </h1>
//               <p className="text-base md:text-lg mb-6 text-red-200">
...
//               Our Purpose & Values
//             </h2>
//             <p className="text-center mb-12 text-red-200 max-w-2xl mx-auto text-base">
...
//             </h2>
//             <div className="border-t-4 border-red-500 my-6 w-32 mx-auto"></div>
//           </div>
//           <div className="text-red-100 text-base max-w-3xl mx-auto">
//             <p className="mb-6">
...
export default function AboutUs() {
  ...
  return (
    ...
    //         <div className="w-full md:w-1/2 mb-8 md:mb-0">
    //           <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-red">
    //             Welcome to Ignited Minds
    //           </h1>
