...
//               />
//               <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent hidden md:block">
//                 <h3 className="text-white text-xl font-bold truncate">{card.title}</h3>
//               </div>
//             </div>
//           </div>
//         ))}
