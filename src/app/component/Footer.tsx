...
const Footer: FC = () => {
  return (
    <footer
      className="relative w-full py-12 bg-gradient-to-r from-purple-50 to-purple-200 bg-cover bg-center"
      ...
      <div className="max-w-7xl mx-auto px-10 grid sm:grid-cols-12 gap-4">
        ...
        <div className="sm:col-span-3 flex flex-col items-center md:items-start space-y-2">
          <img
            ...
            className="ml-6 h-60 w-auto hidden sm:block"
          />
          <img
        ...
        {/* Useful Links */}
        <div className="sm:col-span-2 text-center md:text-left mt-8 md:mt-8 sm:ml-12 hidden sm:block">
          <h4 className="text-lg font-semibold mt-10 text-black">
            Useful Link
          </h4>
        ...
        <div className="sm:col-span-5 mt-8 md:mt-0 flex flex-col items-center md:items-center">
          <h4 className="text-xl font-semibold mb-4 text-black text-center md:text-left">
            Find us on map
          </h4>
          <iframe
