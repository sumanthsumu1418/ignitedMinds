      ...
      <div className="space-y-4 text-white">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            { icon: Wrench, text: "Hands-on Projects" },
    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="relative h-screen overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/image/Courses/snowflake.png"
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4">
          ...
          >
            Master the art of data warehousing and analytics with Snowflake
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="absolute inset-0 bg-[url('/path/to/snowflake-pattern.svg')] opacity-10"></div>
        <motion.h2
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
