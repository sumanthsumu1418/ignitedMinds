...
//   { src: "/image/Courses/d1.jpeg", alt: "Right Placement is here!! (8)" },
// ];
...
//             Master the art of Data Analyst
//           </p>
//           <Link
//             href="/registration"
...
// import DataAnalystCourse from "./DataAnalystCourse";
import Script from "next/script";
import DataAnalystCourse from "./DataAnalystCourse";

export const metadata: Metadata = {
  title:
    "Data Analyst Training Course – Learn Data Analytics with Hands-On Projects",
  description:
    "Become a certified Data Analyst with Ignited Minds. Master data visualization, SQL, Excel, Python, and Tableau through practical training, real-world projects, and placement assistance.",
  keywords:
    "Data analyst training, data analytics course, learn Tableau and Excel, data visualization training, Python for data analysts, SQL for data analytics, data analytics certification, career-focused data analyst course, best data analytics training Bangalore",
  openGraph: {
    title:
      "Data Analyst Training Course – Learn Data Analytics with Hands-On Projects",
    description:
      "Master data analytics with hands-on projects and expert mentorship. Get placement assistance and start your tech career.",
    url: "https://www.ignitedmindslearning.com/data-analyst",
    images: [
      {
        url: "https://www.ignitedmindslearning.com/og-data-analyst.jpg",
        width: 1200,
        height: 630,
        alt: "Data Analyst Training Course",
      },
    ],
  },
};
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            name: "Data Analyst Training Course",
            description:
              "Master data analytics with hands-on projects and expert mentorship",
            provider: {
              "@type": "Organization",
            ...
            educationalCredentialAwarded: "Data Analyst Certification",
            timeRequired: "P12W",
            occupationalCredentialAwarded: "Certified Data Analyst",
          }),
        }}
      />
      <DataAnalystCourse />
