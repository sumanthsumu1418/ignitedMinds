...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Zero Copy Cloning in Snowflake: Efficient Data Management",
    description:
      "Explore the power of Zero Copy Cloning in Snowflake for cost-effective and instant data replication. Perfect for testing, development, and data sharing.",
    images: [
      {
        url: "https://www.ignitedmindslearning.com/og-snowflake-zero-copy-cloning.jpg",
        width: 1200,
        height: 630,
        alt: "Snowflake Zero Copy Cloning",
      },
    ],
  },
};
...
export default function Page() {
  return <SnowflakeZeroCopyContent />;
}
