...
//   { src: "/image/Courses/s1.jpeg", alt: "Right Placement is here!! (8)" },
// ];
...
// export default function SnowflakeCourse() {
...
//           optimization. Our Snowflake course is designed to kickstart your
//           career in data engineering and analytics.
//         </p>
...
//     ),
//     objectives: [
//       "Understand Cloud Data Warehousing Concepts",
//       "Learn Snowflake Architecture",
//       "Master Data Loading and Unloading",
//       "Query Optimization",
//       "Work with Semi-Structured Data",
//       "Integrate with ETL/ELT Tools",
//       "Explore Security and Data Governance",
//       "Leverage Snowflake for Advanced Analytics",
//       "Master Snowflake's Time Travel and Data Cloning",
...
//       "Daily Class PDF/Word Materials",
//       "Daily Class Recorded Videos",
//       "10+ Live Telephonic Interview Audios",
//       "2 Batch Repetitions allowed with zero cost",
//     ],
//   };
//   const tabContent = {
...
//         <div className="relative w-full h-full md:h-auto md:pb-[70%]">
//           <Image
...
//             Snowflake/ETL Testing Course
//           </h1>
//           <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-8">
//             Master the art of data warehousing and analytics with Snowflake/ETL
//             Testing
//           </p>
//           <Link
//             href="/registration"
...
//             <div className="text-whitetext-white flex-shrink-0 relative">
//               <motion.div
...
import SnowflakeCourse from "./SnowflakeCourse";
import Script from "next/script";

export const metadata: Metadata = {
  title: "Snowflake Data Engineering Course – Master Cloud Data Solutions",
  description:
    "Learn Snowflake and ETL Data Engineering at Ignited Minds. Build expertise in cloud data warehousing, ETL pipelines, and analytics with hands-on projects and job placement support.",
  keywords:
    "Snowflake training course, ETL data engineering, cloud data solutions, learn Snowflake, Snowflake certification course, data analytics with Snowflake, Snowflake ETL training, cloud data warehousing, career-focused data engineering",
  openGraph: {
    title: "Snowflake Data Engineering Course – Master Cloud Data Solutions",
    description:
      "Master cloud data warehousing and analytics with hands-on projects and expert mentorship. Get placement assistance and start your tech career.",
    images: [
      {
        url: "https://www.ignitedmindslearning.com/og-snowflake.jpg",
        width: 1200,
        height: 630,
        alt: "Snowflake Data Engineering Course",
      },
    ],
  },
};
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            name: "Snowflake Data Engineering Course",
            description:
              "Master Snowflake Data Engineering with hands-on projects and expert mentorship",
            provider: {
              "@type": "Organization",
            ...
            courseCode: "SDE-001",
            coursePrerequisites: "Basic SQL and data concepts knowledge",
            educationalCredentialAwarded:
              "Snowflake Data Engineer Certification",
            timeRequired: "P12W",
            occupationalCredentialAwarded: "Snowflake Data Engineer",
          }),
        }}
      />
      <SnowflakeCourse />
