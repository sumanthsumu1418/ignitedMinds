...
import PythonDataEngineeringCourse from "./PythonDataEngineeringCourse";
import Script from "next/script";

export const metadata: Metadata = {
  title: "Python Data Engineering Course – Master Data Pipelines & Analytics",
  description:
    "Become a Python Data Engineer with Ignited Minds. Learn Python, ETL, SQL, and Big Data tools through hands-on projects, expert mentorship, and job placement support.",
  keywords:
    "Python data engineering course, data engineering with Python, ETL pipelines training, Big Data tools course, Python for data engineers, learn SQL for data engineering, hands-on data engineering projects, career-focused Python training, data analytics certification",
  openGraph: {
    title: "Python Data Engineering Course – Master Data Pipelines & Analytics",
    description:
      "Master Python Data Engineering with hands-on projects and expert mentorship. Get placement assistance and start your tech career.",
    images: [
      {
        url: "https://www.ignitedmindslearning.com/og-python-data.jpg",
        width: 1200,
        height: 630,
        alt: "Python Data Engineering Course",
      },
    ],
  },
};
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            name: "Python Data Engineering Course",
            description:
              "Master Python Data Engineering with hands-on projects and expert mentorship",
            provider: {
              "@type": "Organization",
            ...
            educationalCredentialAwarded: "Python Data Engineer Certification",
            timeRequired: "P12W",
            occupationalCredentialAwarded: "Python Data Engineer",
          }),
        }}
      />
      <PythonDataEngineeringCourse />
    </>
  );
}
